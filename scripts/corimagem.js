const imagemlogo_resultado = 
    document.getElementById("imagemlogo_resultado");
const s1c1 = document.getElementById("s1c1");
const s1c2 = document.getElementById("s1c2");
const s1c3 = document.getElementById("s1c3");
...
s1c1.addEventListener("click", () => {
    imagemlogo_resultado.setAttribute(
        "src", "imgs/nobackground/logocor1.png"
    );
});
s1c2.addEventListener("click", () => {
    imagemlogo_resultado.setAttribute(
        "src", "imgs/nobackground/logocor2.png"
    );
});
s1c3.addEventListener("click", () => {
    imagemlogo_resultado.setAttribute(
        "src", "imgs/nobackground/logocor3.png"
    );
});
s1c4.addEventListener("click", () => {
    imagemlogo_resultado.setAttribute(
        "src", "imgs/nobackground/logocor4.png"
    );
});
s1c5.addEventListener("click", () => {
    imagemlogo_resultado.setAttribute(
        "src", "imgs/nobackground/logocor5.png"
    );
});
s1c6.addEventListener("click", () => {
    imagemlogo_resultado.setAttribute(
